...
void simulator(string dfa_tab[][3], string word, int state)
{
    ...
    for (i = 0; i < len; i++)
    {
        ...
        {
            cout << endl
                 << "String does not belong to given regular expression." << endl
                 << endl;
            break;
        }
        else
    ...
    if (i == len)
    {
        ...
        for (j = 0; j < _b; j++)
        {
            ...
            {
                cout << endl
                     << "String belongs to given regular expression." << endl
                     << endl;
                break;
            }
        }
        ...
        {
            cout << endl
                 << "String does not belongs to given regular expression." << endl
                 << endl;
        }
    } /*else{
